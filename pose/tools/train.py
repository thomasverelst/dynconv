...
def main():
    ...
    if cfg.DYNCONV.ENABLED:
        sparsity_criterion = dynconv.SparsityCriterion(cfg.DYNCONV.TARGET, 
                                    cfg.TRAIN.END_EPOCH, cfg.DYNCONV.WEIGHT)
    ...
    for epoch in range(begin_epoch, cfg.TRAIN.END_EPOCH):
        ...
        # train for one epoch
        train(cfg, train_loader, model, criterion, sparsity_criterion, optimizer, epoch,
        ...
        perf_indicator = validate(
            ...
            final_output_dir, tb_log_dir, epoch, writer_dict
        )
        ...
        }, best_model, final_output_dir, epoch= epoch)

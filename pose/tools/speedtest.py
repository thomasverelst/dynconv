...
from core.function import speedtest
...
def main():
    ...
    logger, final_output_dir, tb_log_dir = create_logger(
        cfg, args.cfg, 'valid', dry=True)

    logger.info('>>>>>>>>>>>>>>>>>> SPEEEDTEST <<<<<<<<<<<<<<<<<<<<<')
    ...
    speedtest(cfg, valid_loader, valid_dataset, model, criterion,
